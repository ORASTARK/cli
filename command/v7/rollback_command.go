...
type RollbackCommand struct {
	...
	Version         string       `long:"revision" required:"true" description:"Roll back to the given app revision"`
...
func (cmd RollbackCommand) Execute(args []string) error {
	...
	revision, warnings, err := cmd.Actor.GetRevisionByApplicationAndVersion(app.GUID, cmd.Version)
	cmd.UI.DisplayWarnings(warnings)
